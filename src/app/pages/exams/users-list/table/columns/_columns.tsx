...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  },
  {
    ...
    id: 'exam_name',
    Cell: ({...props}:any) => <ExamName coupon_title={props.data[props.row.index].name} id={props.data[props.row.index].id} />,
  },
  {
    Header: (props) => (
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Exam Status' className='min-w-125px' />
    ),
    id: 'active',
    Cell: ({...props}:any) => (
      <UserTwoStepsCell
        status={props.data[props.row.index].draft}
