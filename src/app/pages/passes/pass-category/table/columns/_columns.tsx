...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Pass Category Name' className='min-w-125px' />
    ),
    id: 'passes_name',
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Pass Category features' className='min-w-125px' />
    ),
    id: 'Features',
    Cell: ({...props}:any) => <UserInfoCell features={props.data[props.row.index].features} />,
  },
  // {
  //   Header: (props) => (
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Visible on Panel' className='min-w-125px' />
    ),
    id: 'active',
    Cell: ({...props}:any) => (
      <UserTwoStepsCell
