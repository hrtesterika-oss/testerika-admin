...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  },
  {
    ...
    // accessor: 'name',
    id: 'full_name',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].full_name} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Email' className='min-w-125px' />,
    // accessor: 'email',
    id: 'email',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].email} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Phone Number' className='min-w-125px' />,
    // accessor: 'email',
    id: 'phone_number',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].phone_number} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Current Location' className='min-w-125px' />,
    // accessor: 'email',
    id: 'current_location',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].current_location} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Current Company' className='min-w-125px' />,
    // accessor: 'email',
    id: 'current_company',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].current_company} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Profile' className='min-w-125px' />,
    // accessor: 'email',
    id: 'position_applied_for',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].position_applied_for} />,
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Total Experience' className='min-w-125px' />,
    // accessor: 'email',
    id: 'total_experience',
    Cell: ({...props}:any) => <EmployeeDetail name={props.data[props.row.index].total_experience} />,
  },
  // {
