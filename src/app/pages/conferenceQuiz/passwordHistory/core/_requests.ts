...
const API_URL = window.location.host==="localhost:3011" ? 'http://localhost:5006/api/conferenceQuiz/quiz/admin' : 'http://localhost:5006/api/conferenceQuiz/quiz/admin'
const API_URL2 = window.location.host==="localhost:3011"?"https://api.testerika.com/api/conferenceQuiz/quiz" : "https://api.testerika.com/api/conferenceQuiz/quiz"
...
const getUsers = (query:string) => {
  return axios
    .get(`${API_URL}/getAllPasswordHistory?${query}`)
    .then((d: any) => d.data)
}
