...
const Blog = () => {
  ...
  const uploadImage = async (file: any) => {
    ...
    const getAllBlog=async ()=>{
         const {data}=await axios.get(`${QUIZOPHY_PODIUM_API_URL}/admin/blog`)
         if(data?.success){
            setBlogs(data?.data)
         }
    }
           ...
           <div className="row gy-5">
             ...
             {permissionList?.can_view && 
                  <button className="btn my-2 btn-primary text-center" onClick={()=>{
                    navigate("/conference-quiz/blog/draft")
                }}>
                   View Draft
                </button>
               }
                ...
                {permissionList?.can_create && 
                  <button className="btn my-2 btn-primary text-center" onClick={()=>{
                    navigate("/conference-quiz/blog/create")
                }}>
                    Create New Blog
                </button>
               }
              ...
              <div style={{width:"600px",padding:"30px"}}>
                 ...
                 <div className="col-12 my-4">
                  ...
                  <div className="mx-auto text-center">
                    {
                      posterImage!="" && <button className="btn btn-primary text-center mx-auto my-5" onClick={async (e:any)=>{
                            e?.preventDefault()
